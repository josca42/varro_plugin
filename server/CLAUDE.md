...
Code-level notes (architecture, dev/ops, persistence design) live in [agents/](agents/index.md). Plugin-wide guidance is in [../CLAUDE.md](../CLAUDE.md) and [../notes/](../notes/index.md).
